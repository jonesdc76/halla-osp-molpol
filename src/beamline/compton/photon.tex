...
The Compton polarimeter has been running since February 1999 and has been used by several HALL A
experiments.
}
...
During 50's and 60's, the QED theoretical developments allow Klein and Nishina to compute accurately
the so-called Compton interaction cross section. Experimental physicists performed several experiments which
are in good agreement with the predictions. This is now a well established
...
The polarization of the Jefferson Lab electron beam is flipped 30 times per second. Upon interaction
...
electrons helicity state (aligned or anti-aligned with the propagation direction). These numbers are
dependent of process cross sections, luminosity at the interaction point and time of the experiment.
At first order, assuming the time and luminosity are equal for the both electron helicity states, the
counting rates asymmetry is directly proportional to the theoretical cross section asymmetry.
From one to the other
The proportionality factor is equal to the values of the photon circular polarization Pphoton
multiplied by the
...
are interacting, these polarization measurements are completely non-invasive for the electron beam
in term of positions, the orientations and the physical
characteristics of the beam at the exit of the polarimeter.
...
beam. Illustrated in Fig.\ref{fig:compton_edet} is a view of the actual electron detector.
 \begin{figure}[htp]
    \begin{center}
        \includegraphics*[angle=0,scale=0.6]{compton_edet}
    \end{center}
...
of the ADC range.An automatic fit procedure subtracts the background and calibrate 
...
\hline
 {\em David } & {\em Gaskell} & JLab   & 6092  & 6092  & gaskelld@jlab.org     & Contact     \\
 ...
 David    &  Lhuillier       &  CEA   & 9497* &       & dlhuillier@Cea.Fr  & Analysis  \\
  ...
  Gérard  &  Tarte           &  CEA   & 8464* &       & gtarte@Cea.Fr      & Electronics\\
Christian &  Veyssière       &  CEA   & 9704* &       & cveyssiere@Cea.Fr  & Electronics \\
\hline
\end{tabular}  
\end{center}
