\newcommand{\DaveMack}[1]{Dave Mack & Hall-A/C & 7442 &  & \email{mack@jlab.org} & #1 \\ }
\newcommand{\AndrewLumanog}[1]{Andrew Lumanog & Hall-A & 7459 & â327-5523 & \email{andrewl@jlab.org} & #1 \\ }
\newcommand{\JasonGlorioso}[1]{Jason Glorioso & Hall-A & 6258 & â831-8713  & \email{glorioso@jlab.org} & #1 \\ }
\newcommand{\MahlonLong}[1]{Mahlon Long & Hall-A & 6436 & â770-5562 & \email{mlong@jlab.org} & #1 \\ }
...
\newcommand{\HariAreti}[1]{Hari Areti & Accel. & 7187 &  & \email{areti@jlab.org} & #1 \\ }
\newcommand{\MarkAugustine}[1]{Mark Augustine & Hall-A & 7103 &  & \email{augustin@jlab.org} & #1 \\ }
...
\newcommand{\WilliamHenry}[1]{ William Henry & Hall-A/C & 7431 &\email{wmhenry@jlab.org} & #1 \\}
\newcommand{\ZakRemele}[1]{ Zachary Remele & Acting Hall-A Work Coordinator & 5121 &\email{remele@jlab.org} & #1 \\}
\newcommand{\AlexandreCamsonne}[1]{Alexandre Camsonne & Hall-A & 5064 &  & \email{camsonne@jlab.org} & #1 \\ }
...
\newcommand{\EugeneChudakov}[1]{Eugene Chudakov & Hall-A & 6959 &  & \email{gen@jlab.org} & #1 \\ }
...
\newcommand{\ChristopherCurtis}[1]{Christopher Curtis & Hall-A & 7086 &  & \email{curtis@jlab.org} & #1 \\ }
...
\newcommand{\AlexandreDeur}[1]{Alexandre Deur & UVA & 7526 &  & \email{deurpam@jlab.org} & #1 \\ }
...
\newcommand{\ToddEwing}[1]{Todd Ewing & Hall-A & 6097 & 349-3461 & \email{jtewing@jlab.org} & #1 \\ }
\newcommand{\HeidiFansler}[1]{Heidi Fansler & Hall-A & 6915 & Web & \email{fansler@jlab.org} & #1 \\ }
\newcommand{\RobertFeuerbach}[1]{Robert Feuerbach & Hall-A & & &  & #1 \\ }
\newcommand{\EdFolts}[1]{Ed Folts & Hall-A & 7857 & Web & \email{folts@jlab.org} & #1 \\ }
\newcommand{\PeteFrancis}[1]{Pete Francis & Hall-A & 7528 &  & \email{francis@jlab.org} & #1 \\ }
...
\newcommand{\RickGonzales}[1]{Rick Gonzales & Hall-A & 7198 &  & \email{gonzales@jlab.org} & #1 \\ }
...
\newcommand{\OleHansen}[1]{Ole Hansen & Hall-A & 7627 &  & \email{ole@jlab.org} & #1 \\ }
\newcommand{\ScottHiggins}[1]{Scott Higgins & Hall-A & 7411 &  & \email{higgins@jlab.org} & #1 \\ }
\newcommand{\DouglasHiginbotham}[1]{Douglas Higinbotham & Hall-A & 7851 &  & \email{doug@jlab.org} & #1 \\ }
\newcommand{\DavidFlay}[1]{David Flay & Hall-A &  &  & \email{flay@jlab.org} & #1 \\ }
\newcommand{\RickAdrover}[1]{Rick Adrover & ESH & 5418 &  & \email{adrover@jlab.org} & #1 \\ }
...
\newcommand{\BertManzlak}[1]{Bert Manzlak & Hall-A & 7556 & â897-2651 & \email{manzlak@jlab.org} & #1 \\ }
...
\newcommand{\DaveMeekins}[1]{Dave Meekins & Physics & 5434 &  & \email{meekins@jlab.org} & #1 \\ }
\newcommand{\BillMerz}[1]{Bill Merz & Hall-A & 5836 &  & \email{merz@jlab.org} & #1 \\ }
...
\newcommand{\DavidGaskell}[1]{David Gaskell & Hall-A & 6092 & & \email{gaskelld@jlab.org} & #1 \\ }
\newcommand{\ChandanGhosh}[1]{Chandan Ghosh & Hall-A & 6271 & & \email{chandan@jlab.org} & #1 \\ }
...
\newcommand{\YiQiang}[1]{Yi Qiang & Duke & 7237 &  & \email{yqiang@jlab.org} & #1 \\ }
...
\newcommand{\SimonaMalace}[1]{Simona Malace & Hall-A &  & & \email{simona@jlab.org} & #1 \\ }
\newcommand{\EllenBecker}[1]{Ellen Becker & Hall-A & 6436 & & \email{ebecker@jlab.org} & #1 \\ }
...
\newcommand{\MarkStevens}[1]{Mark Stevens & Hall-A & 6383 &  & \email{stevensm@jlab.org} & #1 \\ }
...
\newcommand{\MichaelTiefenback}[1]{Michael Tiefenback & Hall-A & 7430 &  & \email{tiefen@jlab.org} & #1 \\ }
...
\newcommand{\BogdanWojtsekhowski}[1]{Bogdan Wojtsekhowski & Hall-A & 7191 &  & \email{bogdanw@jlab.org} & #1 \\ }
\newcommand{\XiaohuiZhan}[1]{Xiaohui Zhan & MIT & OFF & & \email{zhanxh@jlab.org} & #1 \\ }
\newcommand{\JosephZhang}[1]{Joseph Zhang & Hall-A & 5575 &  & \email{shukui@jlab.org} & #1 \\ }
...
\newcommand{\ArunTadepalli}[1]{Arun Tadepalli & Hall-A/C & 6989 & & \email{arunts@jlab.org} & #1\\}
\newcommand{\DonaldJones}[1]{Donald Jones & Hall-A/C & 7434 & & \email{jonesdc@jlab.org} & #1\\}
\newcommand{\CiprianGal}[1]{Ciprian Gal & Hall-A/C & 7123 & & \email{ciprian@jlab.org} & #1\\}
